...
## Why this error occurrs

You have provided a custom `Presence` types for your application, but the type
you provided isn’t a (completely) valid JSON object. Values like `Date`, `Map`,
`Set`, functions, classes, or `unknown` aren’t valid JSON. This works prety well.
